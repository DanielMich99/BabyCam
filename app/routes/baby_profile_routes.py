...
# Create a new baby profile (user_id is inferred from the authenticated user)
...
# Retrieve all baby profiles associated with the currently authenticated user
...
# Retrieve a specific baby profile by its ID (only if it belongs to the authenticated user)
...
# Update a specific baby profile by its ID (only if it belongs to the authenticated user)
...
# Delete a specific baby profile by its ID (only if it belongs to the authenticated user)
